package infraguard.rules.terraform.alb_all_listenter_has_server
...
rule_meta := {
	...
	"resource_types": ["alicloud_alb_listener"],
	"iac_type": "terraform"
}
