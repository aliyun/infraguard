package infraguard.rules.terraform.cr_repository_image_scanning_enabled
...
rule_meta := {
	...
	"reason": {
		...
		"pt": "A varredura de imagem ajuda a identificar e prevenir a implantação de contêineres vulneráveis."
	},
	"recommendation": {
	...
	"resource_types": ["alicloud_cr_ee_instance"],
	"iac_type": "terraform"
}

is_compliant(resource) if {
	image_scanner := tf.get_attribute(resource, "image_scanner", "")
	image_scanner != ""
	not tf.is_unknown(image_scanner)
}
