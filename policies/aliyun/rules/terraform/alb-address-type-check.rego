package infraguard.rules.terraform.alb_address_type_check
...
is_compliant(resource) if {
	address_type := tf.get_attribute(resource, "address_type", "")
	not tf.is_unknown(address_type)
	lower(address_type) == "intranet"
}
