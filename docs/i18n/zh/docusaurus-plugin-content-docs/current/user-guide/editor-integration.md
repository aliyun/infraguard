...
从 [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=aliyun.infraguard) 安装 **InfraGuard** 扩展，或在 VS Code 扩展面板中搜索 "InfraGuard"。

该扩展需要将 `infraguard` CLI 安装并添加到 PATH 中。详见 [安装](../getting-started/installation)。
